...
# set logging
filehandler = logging.FileHandler(splunkhome + "/var/log/splunk/gsoctbox_gsoccsvmassgen.log", 'a')
                ...
                if isinstance(item, dict):
                    ...
                    try:
                        ...
                        entity_dict = {
                            ...
                            'gsoc_csv_app': item.get("gsoc_csv_app"),
                            'gsoc_csv_lookup_file': item.get("gsoc_csv_lookup_file"),
                            'spl': item.get('spl'),
                        }
                        ...
                        logging.error("sounds lile the report is corrupted, exception=\"{}\"".format(str(e)))
